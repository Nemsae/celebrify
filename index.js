function celebrify (str) {
  ...
  var allArr = [jaydenArr, khaledArr, bushArr];
  var resultStr = '';
  ...
  switch (str) {
    ...
    case 'Jayden smith':
    case 'Jayden': {
      var randomNum = Math.floor(Math.random() * jaydenArr.length);
      resultStr = jaydenArr[randomNum];
    } break;
    case 'Random':
    case 'random': {
      var randomAllArrNum = Math.floor(Math.random() * allArr.length);
      var randomRanArr = allArr[randomAllArrNum];
      var randomRanArrLength = allArr[randomAllArrNum].length;
      // console.log('randomRanArr: ', randomRanArr);
      var randomRanArrNum = Math.floor(Math.random() * randomRanArrLength);
      var randomQuote = randomRanArr[randomRanArrNum];
    ...
    case 'Khaled':
    case 'DJ Khaled': {
      var randomNum1 = Math.floor(Math.random() * khaledArr.length);
      resultStr = khaledArr[randomNum1];
    } break;
    case 'George Bush':
    case 'George W. Bush':
    case 'george w. bush':
    ...
    case 'bush':
    case 'Bush': {
      var randomNum2 = Math.floor(Math.random() * khaledArr.length);
      resultStr = khaledArr[randomNum2];
    } break;
    // case 'Britney Spears':
    // case 'Britney spears':
    // case 'britney spears':
    ...
    // case 'britney':
    // case 'Britney': {
    //   var randomNum = Math.floor(Math.random() * khaledArr.length);
